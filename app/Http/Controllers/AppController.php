    ...
    public function createApp(Request $request) 
    {
       ...
       // echo JWTAuth::getToken(); exit;
        if($user)
        {
            ...
            $insertData['app_code'] = Helpers::randomNumber(7);
